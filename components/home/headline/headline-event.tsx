            ...
            <div className="container mx-auto">
                <div className="flex align-middle py-8">
                    <div className="align-middle h-max mr-6">
                        <span className="text-4xl text-pink font-bold md:pt-8 w-fit">Upcoming:</span>
                    </div>
                    <div className="">
                        <span className="text-4xl text-center text-white font-semibold md:pt-8">{event.title}</span>
                    </div>
                </div>
                <DateComponent className="text-white italic text-lg" dateString={event.date} />
                <MarkdownContent markdownContent={event.description} />
                <div className="flex justify-center">
                    <LinkButton href={`/events/${event.slug}`}><span className="text-2xl font-semibold">Find out more</span></LinkButton>
                </div>
            </div>
        </>
    )
